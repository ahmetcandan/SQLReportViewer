...
namespace SQLReportViewer.Controllers
{
    public class DbConnectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DbConnectionId,ConnectionName,ConnectionString,IsActive,IsDelete")] DbConnection dbConnection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DbConnectionId,ConnectionName,ConnectionString,IsActive,IsDelete")] DbConnection dbConnection)
        {
